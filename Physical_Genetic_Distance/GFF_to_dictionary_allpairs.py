...
Calculates the physical distance (base pairs) between two genes (every combination possible on the same chromosome) and checks the class type (canonical or non-canonical) of each gene of the pair.
Calcule la distance physique (en paires de bases) entre deux gènes (toutes les paires possibles sur le même chromosome) et check la catégorie de fonctionnalité (canonique ou non) pour chaque gène de la paire.
...
# ----------------------------------------------------------------
# Fonction pour calculer les distances pairwise entre tous les gènes
# ----------------------------------------------------------------

def calculate_pairwise_phy_dist_from_dict(dico_gff):
...
if __name__ == "__main__":
    ...
    results = calculate_pairwise_phy_dist_from_dict(dico_gff)
